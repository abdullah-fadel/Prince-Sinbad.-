...
/* ===== EGYPT MAP (appended — indices 16..21) =======================
   New scenario/enemies: bandaged mummies (U, slow & tanky), desert snakes
   (N, fast & low) and sand scorpions (S), on the egypt biome. Same solid-
   floor template so traversal is always unbroken. ==================== */
{ name:{ar:'بوابة الأهرام',en:'Gate of the Pyramids'},
  story:{ar:'يعبر عبدالله البحر إلى مصر — عند بوابة الأهرام تنهض العقارب والأفاعي من الرمال.',
         en:'Abdullah crosses to Egypt — at the gate of the pyramids, scorpions and snakes rise from the sand.'},
  biome:'egypt', rows:[
"                                                              ",
"              CCC                        CCC                  ",
"             =====                      =====                 ",
...
{ name:{ar:'وادي الأفاعي',en:'Valley of Serpents'},
  story:{ar:'وادٍ ضيّق تسكنه الأفاعي — تنساب سريعةً على الرمال، فاحذر لدغاتها.',
         en:'A narrow valley of serpents — they race low across the sand; beware their strike.'},
  biome:'egypt', rows:[
"                                                              ",
"          CCC       ^^^        CCC                            ",
"         =====     ====       =====          H               ",
...
{ name:{ar:'معبد الرمال',en:'Temple of Sands'},
  story:{ar:'داخل معبد الرمال تستيقظ أوّل مومياء — بطيئةٌ لكنها لا تتوقّف عن ملاحقتك.',
         en:'Inside the Temple of Sands the first mummy awakens — slow, but it never stops coming.'},
  biome:'egypt', rows:[
"                                                              ",
"              CCC                        CCC                 ",
"             =====        H             =====                ",
...
{ name:{ar:'سرداب المومياوات',en:'Crypt of the Mummies'},
  story:{ar:'سردابٌ مظلمٌ تحرسه المومياوات — احذر ما يزحف في الظلام والتقط النار لتنجو.',
         en:'A dark crypt guarded by mummies — beware what crawls in the dark, and grab fire to survive.'},
  biome:'egypt', rows:[
"                                                              ",
"           CCC                           CCC                 ",
"          =====        P                =====                ",
...
{ name:{ar:'قاعة الفراعنة',en:'Hall of the Pharaohs'},
  story:{ar:'قاعة الفراعنة العظيمة — عقاربٌ وأفاعٍ ومومياواتٌ تحرس كنز الملوك.',
         en:"The great Hall of the Pharaohs — scorpions, snakes and mummies guard the kings' treasure."},
  biome:'egypt', rows:[
"                                                              ",
"          CCC       CCC       CCC       CCC                  ",
"         =====     =====     =====     =====                 ",
...
{ name:{ar:'لعنة الملك',en:"The King's Curse"},
  story:{ar:'لعنة الملك القديم! جيشٌ من المومياوات يسدّ الطريق — بدّل بين السيف والنار ولا تتوقّف.',
         en:"The old king's curse! A wall of mummies bars the road — switch between sword and fire and never stop."},
  biome:'egypt', rows:[
"                                                              ",
"              CCC          P             CCC                 ",
"             =====        H             =====                ",

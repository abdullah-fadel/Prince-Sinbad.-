...
const STR = {
  ar: {
    ...
    'controls.hint': 'غيّر الحجم وجهة اليد — الأزرار تتحدّث مباشرة.',
    'controls.size': 'حجم الأزرار',
    'controls.hand': 'جهة التحكم',
    'controls.handLeft': '🕹 الحركة يسار / الأزرار يمين',
    'controls.handRight': '🕹 الحركة يمين / الأزرار يسار',
  ...
  en: {
    ...
    'controls.hint': 'Adjust size and handedness — the buttons update live.',
    'controls.size': 'Button size',
    'controls.hand': 'Handedness',
    'controls.handLeft': '🕹 Move left / actions right',
    'controls.handRight': '🕹 Move right / actions left',

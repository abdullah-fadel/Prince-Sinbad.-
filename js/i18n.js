...
const STR = {
  ar: {
    ...
    'controls.hint': 'اسحب أي زر أو العصا لتغيير مكانه، واضغطه ثم استخدم شريط الحجم.',
    'controls.size': 'الحجم',
    'controls.opacity': 'الشفافية',
  ...
  en: {
    ...
    'controls.hint': 'Drag any button or the joystick to move it; tap it, then use the size slider.',
    'controls.size': 'Size',
